...
$conn = new PDO('mysql:host=localhost;dbname=ranking;charset=utf8', 'root', 'root', [PDO::ATTR_DEFAULT_FETCH_MODE => PDO::FETCH_OBJ, PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION]);
...
$stmtSelect = $conn->query('SELECT * FROM ranking order by stars DESC limit 10');
